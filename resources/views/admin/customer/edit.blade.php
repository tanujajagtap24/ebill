                ...
                <div class="form-group">
                  ...
                  value="{{$editData->id}}">
                    <div class="col-lg-6">
                      ...
                      <input type="text" class="form-control" id="cust_name" name="cust_name" value="{{$editData->Customer_Name}}">
                    </div>
                    <div class="col-lg-6">
                      <label for="">Customer Group</label>
                      <select name="cust_grp" id="cust_grp" class="form-control">
                        <option value="{{$editData->Group}}">  {{$editData->Group}}   </option>
                  ...
                  <div class="row pt-3">
                    ...
                    <div class="col-lg-6">
                      ...
                      <select name="cust_pin" id="cust_pin" class="form-control">
                        <option value="{{$editData->Pincode}} "> {{$editData->Pincode}}  </option>
                        @foreach ($cityData as $data)
                  ...
                  <div class="row pt-3">
                    <div class="col-lg-6">
                      ...
                      <input type="text" class="form-control" id="mob" name="mob" value="{{$editData->Mobile_Number}}">
                    </div>
                    <div class="col-lg-6">
                      <label for="">Email</label>
                      <input type="email" class="form-control" id="mail" name="mail" value="{{$editData->Email}}">
                    </div>
                  </div>
                  <div class="row pt-3">
                    <div class="col-lg-12">
